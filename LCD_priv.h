...
//dah bta3 eltawselat 
typedef struct {
	uint8 u8LineMode     :1 ; //wafarna memory kolohom ya zero ya one fa m7tageen one bite bas
	uint8 u8CharFont     :1 ;
...
//dah bta3 eloptions ely gowa ellcd
typedef struct {
	tstrLcdPinOutCfg strLcdPinOutCfg;
	tstrLcdOptionCfg strLcdOptionCfg ;
}tstrLcdCfg; //3ashan ngma3hom ma3 ba3d elpins w eloptions of lcd
